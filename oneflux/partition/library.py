...
def load_output(filename, delimiter=',', skip_header=1):
    ...
    it = numpy.nditer(new_data['timestamp_start'], flags=['f_index']) # Modify by minan
...
def create_data_structures(ustar_type, whole_dataset_nee, whole_dataset_meteo, percentile, year_mask_nee, year_mask_meteo, latitude, part_type=NT_STR):
    ...
    # headers
    original_headers = ['Year', 'Month', 'Day', 'Hour', 'Minute', 'NEE', 'Tair', 'Tsoil', 'VPD', 'Lat', 'Rg', 'Tair_f', 'Rg_f', 
                        'Tsoil_f', 'qcNEE', 'NEE_f', 'NEE_fqc', 'NEE_fqcOK']
